...
// 		newPElem.textContent = htmlCode;
// 		document.getElementById('result2').appendChild(newPElem);
// 	})
// 	.catch((error) => {
// 		console.error('Ошибка:', error);
// 	});
...
// 			resultElement.textContent = `IP : ${getIp}`;
// 		})
// 		.catch((error) => {
// 			console.error('Ошибка:', error);
// 		});
...
// 	resultElement.textContent = `Геопозиция введенного IP адреса: ${data.country}, ${data.city}`;
// })
// 	.catch((error) => {
// 		console.error('Ошибка:', error);
// 	});
...
// 			setup.innerHTML = `Затравка: ${data.setup}`;
// 			punchline.innerHTML = `Ответ: ${data.punchline}`;
// 			resultElement.innerHTML = '';
// 			resultElement.appendChild(setup);
// 			resultElement.appendChild(punchline);
// 		})
// 		.catch((error) => console.error('Ошибка:', error));
// }
...
// Выведется Вася, если сделать консоль лог, то петя выведется потом 
